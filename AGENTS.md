...
Orc.NuGetExplorer is a WPF library that provides everything you need to explore and download packages from the NuGet gallery as well as any private feed.

Orc.NuGetExplorer consists of the following projects:

- **Orc.NuGetExplorer** — Core library with NuGet package management functionality.
- **Orc.NuGetExplorer.Xaml** — WPF UI library containing views, view models, and controls for the NuGet explorer.
- **Orc.NuGetExplorer.Tests** — Test project.
- **Orc.NuGetExplorer.Example** — Example WPF application demonstrating usage.
...
|------------|-------------------|
| Orc.NuGetExplorer | `master` |
| Orc.NuGetExplorer | `develop` |
...
```
Orc.NuGetExplorer      => Core library: services, models, providers, NuGet integration
Orc.NuGetExplorer.Xaml => WPF UI: views, view models, controls, behaviors
```
...
| `src/Orc.NuGetExplorer/` | Yes | Core library source |
| `src/Orc.NuGetExplorer.Xaml/` | Yes | WPF UI source |
| `src/Orc.NuGetExplorer.Tests/` | Yes | Test source |
| `src/Orc.NuGetExplorer.Example/` | Yes | Example application source |
