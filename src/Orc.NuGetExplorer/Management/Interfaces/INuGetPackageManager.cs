...
public interface INuGetPackageManager : IPackageManager
{
    ...
    Task<IReadOnlyList<PackageReference>> GetInstalledPackagesAsync(IExtensibleProject project, CancellationToken token);
    ...
    IReadOnlyList<SourceRepository> AsLocalRepositories(IEnumerable<IExtensibleProject> projects);
