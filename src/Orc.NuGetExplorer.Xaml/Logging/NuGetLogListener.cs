...
public class NuGetLogListener : PackageManagerLogListenerBase, IConstructAtStartup
{
    private static readonly ILogger Logger = LogManager.GetLogger(typeof(NuGetLogListener));

    public NuGetLogListener(INuGetLogListeningService nuGetLogListeningService)
